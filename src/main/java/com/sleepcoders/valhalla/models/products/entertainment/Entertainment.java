...
public abstract class Entertainment extends Product {
    ...
    public Entertainment(int quantity, double price, double weight, String name, String description, String model, String brand, String color, int powerConsumption, int yearOfProduction, List<String> imageUrlList) {
